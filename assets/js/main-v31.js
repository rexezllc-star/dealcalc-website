...
(function(){
  ...
  function rent(m){ return val('monthlyRent')||num(m.monthlyRent)||num(m.rent)||num(m.validation?.rent?.value)||0; }
...
/* ===== DealCalc V31 Final Stable Analyzer Renderer =====
...
(function(){
  ...
  function price(m){ return val('listingPrice')||val('purchasePrice')||num(m.listingPrice)||num(m.currentListing?.price)||num(m.ask)||num(m.price)||0; }
...
/* ===== End DealCalc V31 Final Stable Analyzer Renderer ===== */
